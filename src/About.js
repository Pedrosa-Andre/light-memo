import { createElement, getUserKey } from "./utils";
...
function About() {
  ...
  const p4 = createElement('p', {textContent: 'Your key: ' + getUserKey()});

  const innerDiv = createElement('div', {className: 'inner-container'}, [p1, p2, p3, p4]);
